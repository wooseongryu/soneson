										...
										<c:forEach var="ExamProject" items="${ExamProjectList}">
											<div class="col-lg-4 col-md-6 col-sm-6" style="">                                                
												<div class="product__item">
			    										...
			    										<div class="product__item__pic set-bg" data-setbg="${ExamProject.img_main }" 
														style="background-image: url('${ExamProject.img_main}')">
														</div>
													</a>
														<div class="product__item__text">                                                   
															...
															<ul style="margin-top: 15px">                                                   
																...
																<li style="float: right">${ExamProject.d_day}</li>                         
															</ul>                                                                           
			    										</div>                                                                               
			    									</div>                                                                                   
			    								</div>
