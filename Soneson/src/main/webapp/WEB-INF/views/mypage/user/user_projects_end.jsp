					    							...
					    							<a href="projectDetail?project_code=${endProject.project_code}">
 					    								<c:choose>
															<c:when test="${fn:contains(endProject.img_main, 'https')}">
																<img src="${endProject.img_main}" alt="프로젝트 썸네일 이미지" style="width:350px; height:200px">
															</c:when>
 					    									<c:when test="${not empty endProject.img_main}">
															...
															<c:otherwise>
																<img src="${pageContext.request.contextPath }/resources/upload/${endProject.img_main }" alt="프로젝트 썸네일 이미지 DB" style="width:350px; height:200px">
															</c:otherwise>
														</c:choose>
													</a>
														<div class="product__item__text">                                                   
															<ul>                                                                            
																<li>${endProject.category }</li>                                           
															</ul>                                                                           
															...
															<h6>${endProject.subtitle}</h6>                                               
															<ul style="margin-top: 15px">                                                   
																<li>${endProject.goal_rate}%</li>                                              
																<li>${endProject.now_amount}원</li>                                            
															</ul>                                                                           
			    										</div> 
			    										<button type="button" class="donerSelectBtn" onclick="donerSelect(${endProject.project_code})">후원자 조회하기</button>                                                                              
			    									</div>                                                                                   
			    								</div>
										</c:forEach>
										</div>                                                                               
