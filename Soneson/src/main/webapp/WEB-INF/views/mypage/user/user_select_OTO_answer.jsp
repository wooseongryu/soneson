                    ...
                    <div class="col-lg-12">
                        <div class="p-5" id="adminAnswer">
                            ...
                            <form class="user" method="post" enctype="multipart/form-data">
                            	<input type="hidden" value="${OTOAnswer.myQuestion_num }">
                                <div class="form-group row">
                                    <div class="col-sm-12 mb-6 mb-sm-0">
										<label for="">질문 제목</label>
                                        <input type="text" value="${OTOAnswer.myQuestion_subject }" class="form-control form-control-user" id="exampleFirstName" readonly="readonly">
                                    </div>
                                </div>
								<div class="form-group row">
                                    <div class="col-sm-12 mb-6 mb-sm-0">
									  <label for="floatingTextarea">질문 내용</label>
									  <textarea rows="10" class="form-control form-control-textarea" id="floatingTextarea" readonly="readonly">${OTOAnswer.myQuestion_content }</textarea>
									</div>
                                </div>
                                <div class="form-group row" >
                                    <div class="col-sm-12 mb-6 mb-sm-0">
									  <label for="floatingTextarea">답변 내용</label>
									  <textarea rows="10" name="myQuestion_answer" class="form-control form-control-textarea" id="floatingTextareaAnswer" readonly="readonly">${OTOAnswer.myQuestion_answer }</textarea>
									</div>
                                </div>
