...
<body>
	...
	<div class="Container__ContainerComponent">
		<div class="MyProjectListWrapper">
			<div align="center">
				<br>
				<c:if test="${!empty ProceedProjectList }">
					<section class="product-page spad">                                                                                                          
   						<div class="container">                                                                                                                  
   					    	<div class="row">                                                                                                                      
   								<div class="col-lg-12">                                                                                                          
   									<div class="product__page__content" >
                           				<div class="row">  
										<c:forEach var="ProceedProject" items="${ProceedProjectList}">
											<div class="col-lg-4 col-md-6 col-sm-6" style="">                                                
												<div class="product__item">
					    							<a href="projectDetail?project_code=${ProceedProject.project_code}">
 					    								<c:choose>
															<c:when test="${fn:contains(ProceedProject.img_main, 'https')}">
																<img src="${ExamProject.img_main}" alt="프로젝트 썸네일 이미지" style="width:350px; height:200px">
															</c:when>
 					    									<c:when test="${not empty ProceedProject.img_main}">
															...
															<c:otherwise>
																<img src="${pageContext.request.contextPath }/resources/upload/${ProceedProject.img_main }" alt="프로젝트 썸네일 이미지 DB" style="width:350px; height:200px">
															</c:otherwise>
														</c:choose>
													</a>
														<div class="product__item__text">                                                   
															<ul>                                                                            
																<li>${ProceedProject.category }</li>                                           
															</ul>                                                                           
															<h5 style="margin-bottom: 7px;">                                                
															<a href="projectDetail?project_code=' + ProceedProject.project_code + '">                            
																${ProceedProject.title }
															</a>                                                                            
															</h5>                                                                           
															<h6>${ProceedProject.subtitle}</h6>                                               
															<ul style="margin-top: 15px">                                                   
																<li>${ProceedProject.goal_rate}%</li>                                              
