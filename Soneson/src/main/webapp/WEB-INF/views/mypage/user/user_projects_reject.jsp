...
<body>
    ...
    <section class="product-page spad">
	    <div class="Category">
			<ul class="Category_ul">
				...
				<li class="DonationTodayCategory_list_item__agFbi item_5" aria-current="true">
	...
	<div class="Container__ContainerComponent">
		<div class="MyProjectListWrapper">
			<div align="center">
				<br>
				<c:if test="${!empty RejectProjectList }">
					<section class="product-page spad">                                                                                                          
   						<div class="container">                                                                                                                  
   					    	<div class="row">                                                                                                                      
   								<div class="col-lg-12">                                                                                                          
   									<div class="product__page__content" >
                           				<div class="row">  
										<c:forEach var="RejectProject" items="${RejectProjectList}">
											<div class="col-lg-4 col-md-6 col-sm-6" style="">                                                
												<div class="product__item">
					    							<a href="projectDetail?project_code=${RejectProject.project_code}">
 					    								<c:choose>
															<c:when test="${fn:contains(RejectProject.img_main, 'https')}">
																<img src="${RejectProject.img_main}" alt="프로젝트 썸네일 이미지" style="width:350px; height:200px">
															</c:when>
 					    									<c:when test="${not empty RejectProject.img_main}">
															...
															<c:otherwise>
																<img src="${pageContext.request.contextPath }/resources/upload/${RejectProject.img_main }" alt="프로젝트 썸네일 이미지 DB" style="width:350px; height:200px">
															</c:otherwise>
														</c:choose>
													</a>
														<div class="product__item__text">                                                   
															<ul>                                                                            
																<li>${RejectProject.category }</li>                                           
															</ul>                                                                           
															...
															<h6>${RejectProject.subtitle}</h6>                                               
															<ul style="margin-top: 15px">                                                   
																<li>${RejectProject.rate}%</li>                                              
																<li>${RejectProject.total}원</li>                                            
																<li>${RejectProject.d_day}</li>
															</ul>                                                                           
			    										</div>                                                                               
														<button type="button" class="donerSelectBtn" onclick="donerSelect(${RejectProject.project_code})">후원자 조회하기</button>                              
			    									</div>                                                                                   
			    								</div>
										</c:forEach>
										</div>                                                                               
