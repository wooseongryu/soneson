  					    							...
  					    							<a href="projectDetail?project_code=${RejectProject.project_code}">
 					    								<c:choose>
															<c:when test="${fn:contains(RejectProject.img_main, 'https')}">
																<img src="${RejectProject.img_main}" alt="프로젝트 썸네일 이미지" style="width:100%; height:100%">
															</c:when>
															<c:otherwise>
																<img src="${pageContext.request.contextPath }/resources/upload/${RejectProject.img_main }" alt="프로젝트 썸네일 이미지 DB" style="width:100%; height:100%">
															</c:otherwise>
														</c:choose>
													</a>
