...
<body>
    ...
    <section class="normal-breadcrumb set-bg" data-setbg="${pageContext.request.contextPath }/resources/soneson/img/normal-breadcrumb.jpg">
        <div class="container">
            <div class="row">
            ...
            <div class="row">
                <div class="col-lg-3">
                    <div class="footer__logo">
                        <a href="./index.html"><img src="${pageContext.request.contextPath }/resources/soneson/img/logo.png" alt=""></a>
                    </div>
                </div>
                <div class="col-lg-6">
